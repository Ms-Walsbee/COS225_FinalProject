...
public class Summarizer {
    ...
    // Constructors
    public Summarizer(String summary, int summaryLength, Map<String, Double> tdfifScores,
            Map<String, Double> sentenceRankings) {
    ...
    // Rank sentences based on the sum total of the TFIDF scores of the words in the
    // sentence
    ...
    public String generateSummary(List<String> sentences) {
        ...
        // Sorts sentences based on their rankings of how important the words are in
        // that sentence
